...
INTEGER, PARAMETER :: doubpres = SELECTED_REAL_KIND(15,100)
...
REAL (KIND=doubpres) :: r1,r2

PRIVATE
PUBLIC :: doubpres, sgrnd, grnd, init_genrand
